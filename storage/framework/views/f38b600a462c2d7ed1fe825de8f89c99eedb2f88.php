...
<?php $component->withAttributes(['submit' => 'updatePassword']); ?>
     <?php $__env->slot('title'); ?> 
        <?php echo e(__('Mettre à jour son profil')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description'); ?> 
        <?php echo e(__('Ajoute à ton profil ta bio et ton statut')); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\wamp\www\PlaceCooperative\resources\views/profile/InformationsProfil.blade.php ENDPATH**/ ?>